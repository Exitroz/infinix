                ...
                <div class="uk-container" data-uk-navbar>
                    ...
                    <div class="uk-navbar-right">
                        <div class="uk-navbar-item uk-visible@m in-optional-nav">
                            <a href="/register" class="uk-button uk-button-primary uk-border-rounded uk-margin-small-right">Create Account</a>
        ...
        <div class="uk-section uk-background-secondary uk-light">
            <div class="uk-container uk-text-small">
                ...
                <div class="uk-grid uk-margin-large-top">
                    <div class="uk-width-1-1">
                        <p class="uk-heading-line uk-margin-large-bottom"><span>Copyright &copy;{{ date('Y') }} {{ ucwords($company->name) }}. All Rights Reserved.</span></p>
