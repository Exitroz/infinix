...
<div class="">
    ...
    <div class="col col-login mx-auto">
        <div class="text-center my-4">
            <svg width="300" height="101.64000462287366" viewBox="0 0 356 110" class="css-1j8o68f">
            ...
            <form class="login100-form validate-form" method="POST" action="{{ route('register') }}">
                ...
                <div class="row">
                    <div class="col-12 col-md-6 mb-3">
                        ...
                        <div class="wrap-input100 validate-input" data-validate="Valid first name is required: john">
                    ...
                    <div class="col-12 col-md-6 mb-3">
                        ...
                        <div class="wrap-input100 validate-input" data-validate="Valid last name is required: doe">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <div class="wrap-input100 validate-input"
                            data-validate="Valid phone number is required: +1919000000">
                ...
                <div class="container-login100-form-btn mb-3">
                    <button type="submit" class="login100-form-btn btn-primary fw-bold">
                        Register
                    </button>
                </div>
                <div class="text-center pt-3">
                    <p class="text-dark mb-0">Already have account?<a href="/login" class="text-primary ms-1">Sign
                            In</a> | Back to <a href="/" class="uk-button uk-button-text">Home</a></p>
                </div>
            </form>
        </div>
    </div>
